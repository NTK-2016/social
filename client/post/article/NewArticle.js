...
class NewArticle extends Component {
  ...
  handleChangeEditor(data) {
    ...
    console.log(newContent.replace(/(&nbsp;|<([^>]+)>)/gi, ""))
    setTimeout(
      function () {
        //Start the timer
        //After 1 second, set render to true
      ...
      <section className={classes.root}>
        <Card className={"cardcustom"}>
          <div className={"upload-back"}><CustomBack class={"fal fa-chevron-left"} backlink={"createpost"} />
            <CardHeader title="Article" className={"cardheadercustom"} />
            {/*avatar={
              <Avatar src={'/api/users/photo/'+this.state.user._id}/>
            } */}
          </div>
          <CardContent className={"cardcontentcustom"}>
            <Typography component="div" className={"artheadimg"}>
              <IconButton aria-label="Add" className={"customicon"}>
                <AddIcon />
              </IconButton>
            ...
            <Typography component="div" className={"upartimg"}>
              <Typography component="span" className="format-img">
                supported png, jpeg{" "}
              </Typography>
            ...
            <Typography component="div" className={"maininner article-editor"}>
              ...
              <Typography component="div" className={"input-div"}>
                ...
                <Typography
                  component="div"
                  className={"length-class editor-type"}
                >
                  {/* <TextField
        id="editor"
        
		label={<span className={"shrinklabel"}>Description</span>}
        style={{ margin: 0 }}
        placeholder="Write Something..."
        fullWidth
         multiline
		...
		InputProps={{ disableUnderline: true  ,classes: {input: this.props.classes['input']},style: {
         padding: 0
       } }} 
      />  */}
              ...
              <Typography component="div" className={"attached-img"}>
                <Typography component="div" className={"headsec form-label"}>
                  Attachment
                </Typography>
                <Typography component="div" className={"img-example"}>
              ...
              {(this.state.choosed == false ||
                ...
                this.state.errors.length > 0) && (
                  <Typography component="div" className={"img-holder"}>
                    ...
                    {this.state.choosed && (
                      <Typography component="p" className={"img-holder-content"}>
                        {" "}
                      </Typography>
                    )}
              ...
              {/* <Typography  component="div" className={"headsec formlabel"}>
          Categories
        </Typography> 
       <Select
          multiple
...
horizontal: "left",
        ...
        >
          {this.state.names.map(name => (
            ...
            <Typography component="div" className={"publishtext"}>
