        ...
        <div className={classes.root}>
          <Card className={"cardcustom"}>
            <div className={"upload-back"}><CustomBack class={"fal fa-chevron-left"} backlink={"createpost"} />
              <CardHeader title="Edit Poll" className={"cardheadercustom"} />
              {/*avatar={
              ...
              <fieldset>
                <div>
                  ...
                  <div className={"bottominner"}>
                    ...
                    {/* <div className={"input1"}> <input type="radio" value="public" 
                  checked={this.state.viewtype === "public"}
                  onChange={this.handleChange('viewtype')} /> Public</div>
                <div className={"input1"}>  <input type="radio" value="stans" 
...
export default withStyles(styles)(EditPoll);
